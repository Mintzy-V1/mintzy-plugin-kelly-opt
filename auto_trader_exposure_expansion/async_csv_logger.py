"""Background, non-blocking CSV writer used by the WS tick path. Moved verbatim
from auto_trader_exposure_expansion.py during the package split; no logic changes.
"""
import csv
import os
import threading
