...
from .risk_monitoring import RiskMonitoringMixin
from .exit_persistence import ExitPersistenceMixin
from .exit_finalization import ExitFinalizationMixin
from .exposure_risk import ExposureRiskMixin
from .order_fill import OrderFillMixin
from .session_broker import SessionBrokerMixin
from .price_feed import PriceFeedMixin
from .eod_exit import EodExitMixin
from .position_maintenance import PositionMaintenanceMixin
...
class AutoTrader(
    RiskMonitoringMixin,
    ExitPersistenceMixin,
    ExitFinalizationMixin,
    ExposureRiskMixin,
    OrderFillMixin,
    SessionBrokerMixin,
    PriceFeedMixin,
    EodExitMixin,
    PositionMaintenanceMixin,
    AnalysisMixin,
    LoggingMixin,
):
                    ...
                    try:
                        ...
                        if (
                            ...
                            if sl_pct is not None and sl_pct > 0:
                                ...
                                qty = self._exit_qty_for(sym, broker_pos["qty"])
